    ...
    <div style={{ minHeight: '100vh', background: '#FAFAFA', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
        <div style={{ width: '100%', maxWidth: 400, background: '#FFFFFF', border: '1px solid #0A0A0A', borderRadius: 6, padding: '36px 32px' }}>
          <h2 style={{ fontFamily: 'var(--serif)', fontSize: 22, fontWeight: 600, color: '#0A0A0A', marginBottom: 4 }}>Sign in</h2>
          <p style={{ fontFamily: 'var(--mono)', fontSize: 10, color: '#888888', marginBottom: 28 }}>Access your private market intelligence</p>
          ...
          <p style={{ fontFamily: 'var(--mono)', fontSize: 10, color: '#888888', textAlign: 'center', marginTop: 20 }}>
            No account? <Link to="/signup" style={{ color: '#0A0A0A', textDecoration: 'underline' }}>Create one</Link>
          </p>
        </div>
      </div>
    </div>
